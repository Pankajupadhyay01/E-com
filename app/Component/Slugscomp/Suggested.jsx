  ...
  return (
    <div>
      <div className="w-[80%] m-auto flex items-center my-[20px]">
        <span className="text-[40px] relative font-[600] before:absolute before:h-[2px] before:w-[80%] before:content-[''] cursor-pointer before:bottom-0 before:bg-blue-500">Similar Product</span>
      </div>
